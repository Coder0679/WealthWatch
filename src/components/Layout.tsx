      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-20 border-b border-[#1F2937] bg-[#111827]/50 backdrop-blur-md sticky top-0 z-30 px-4 md:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button className="p-2 text-[#94A3B8] hover:text-white hover:bg-[#1F2937] rounded-lg transition-colors relative">
              <Bell size={22} />
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-[#1F2937]">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-xs text-[#94A3B8] capitalize">{user?.riskProfile || 'Standard'} Profile</p>
              </div>
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center border-2 border-[#1F2937]">
