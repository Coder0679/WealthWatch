        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
            <div className="flex flex-col gap-6">
              <div>
                ...
                <h1 className="text-4xl font-black text-rose-500">{formatCurrency(totalRemaining)}</h1>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {liabilities.map((liab) => {
              ...
              return (
                <div key={liab.id} className="bg-[#111827] border border-[#1F2937] p-8 rounded-[2rem] relative overflow-hidden group hover:border-rose-500/20 transition-colors">
                  <div className="flex justify-between items-start mb-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-white">{liab.name}</h3>
