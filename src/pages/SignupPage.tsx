        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4">
            <input
              type="text"
              required
              className="block w-full rounded-lg bg-[#0F172A] border border-gray-700 px-3 py-3 text-white placeholder-gray-500 focus:border-green-500 focus:outline-none"
